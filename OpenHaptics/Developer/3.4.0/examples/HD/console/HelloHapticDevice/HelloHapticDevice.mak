# Makefile - HelloHapticDevice.dsp
...
ifdef DEBUG
CFG=HelloHapticDevice_DEBUG
else
CFG=HelloHapticDevice_RELEASE
endif
...
ifeq "$(CFG)"  "HelloHapticDevice_RELEASE"
CFLAGS+=-W -fexceptions -O2 $(INCLUDES) -Dlinux -DNDEBUG -D_CONSOLE
LD=$(CXX) $(CXXFLAGS)
TARGET=HelloHapticDevice
LIBS+=-lHDU -lHD -lrt
else

ifeq "$(CFG)"  "HelloHapticDevice_DEBUG"
