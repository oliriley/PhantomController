# Makefile - CommandJointTorque.dsp
...
ifdef DEBUG
CFG=CommandJointTorque_DEBUG
else
CFG=CommandJointTorque_RELEASE
endif
...
ifeq "$(CFG)"  "CommandJointTorque_RELEASE"
CFLAGS+=-W -fexceptions -O2 $(INCLUDES) -Dlinux -DNDEBUG -D_cplusplus
LD=$(CXX) $(CXXFLAGS)
LIBS+=-lHDU -lHD -lrt
else

ifeq "$(CFG)"  "CommandJointTorque_DEBUG"
CFLAGS+=-W -fexceptions -g -O0 $(INCLUDES) -Dlinux -D_DEBUG -D_cplusplus
LD=$(CXX) $(CXXFLAGS)
LIBS+=-lHDUD -lHD -lrt
endif
endif
