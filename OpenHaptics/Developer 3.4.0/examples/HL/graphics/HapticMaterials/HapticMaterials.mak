...
ifdef DEBUG
CFG=HapticMaterials_Debug
else
CFG=HapticMaterials_Release
endif
...
ifeq "$(CFG)"  "HapticMaterials_Release"
CFLAGS+=-W -fexceptions -O2 $(INCLUDES) -Dlinux -DNDEBUG
LD=$(CXX) $(CXXFLAGS)
LIBS+=-lHL -lHLU -lHD -lHDU -lglut
else

ifeq "$(CFG)"  "HapticMaterials_Debug"
CFLAGS+=-W -fexceptions -g -O0 $(INCLUDES) -Dlinux -D_DEBUG
LD=$(CXX) $(CXXFLAGS)
LIBS+=-lHL -lHLUD -lHD -lHDUD -lglut
endif
endif

ifndef TARGET
TARGET=HapticMaterials
endif
